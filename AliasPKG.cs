...
namespace CMD
{
    internal class AliasPKG : Package
    {
        ...
        private void ClearAliasCMD(string[] args, Command.Callback cb)
        {
            if (_aliases.Count == 0)
        ...
        private void AddAliasCMD(string[] args, Command.Callback cb)
        {
        ...
        private void RemoveAliasCMD(string[] args, Command.Callback cb)
        {
